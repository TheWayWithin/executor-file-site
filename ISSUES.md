...
|----|-------|--------|----------|--------|---------|
| EFS-ISS-8 | Learn posts for two high-intent queries not yet written: 'What happens to my online accounts when I die?' and 'How will my family find my passwords?' (now answered via FAQ questions; dedicated articles remain the highest-value content gap per agent-readability brief section 4) | Open | low | — | pending |
